...
public class Solution {
	...
	private Solution (int id, Date created, Date updated, String description, int exercise_id, int users_id) {
		this.id = id;
		this.created=created;
		this.updated=updated;
		this.description=description;
	...
	static	public Solution[] loadAllSolution(int limit) throws SQLException	{
		ArrayList<Solution> solution = new ArrayList<Solution>();
